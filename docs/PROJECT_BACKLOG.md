...
| Pendiente | P0 | Ejecutar las pruebas MySQL de premios y calendario contra una base efímera o de pruebas. | Dev 4 + Dev 8 | `DATABASE_URL` de pruebas y `npm run db:init` | `RUN_DB_TESTS=1 npm test` pasa y no deja datos persistentes. |
